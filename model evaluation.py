...
fig.savefig(f"{cd}/plots/training_metrics.png", dpi=fig.dpi, bbox_inches='tight')
plt.show()


training_data = pd.read_excel(f"{cd}\\raw_data\model_training_history.xlsx")

# Plotting Performace Metrics
plt.plot(training_data['r2_score'], color = 'k')
plt.plot(training_data['val_r2_score'], linestyle = 'dashed', color = 'r')
...
plt.plot(training_data['loss'], color = 'k')
plt.plot(training_data['val_loss'], linestyle = 'dashed', color = 'r')
